...
How-to: you know what you want; this page lists ports, volumes, editing, reset,
and schema-refresh procedures. If Docker or AM2 is new to you, complete
[Your first local AM2](../tutorial/your-first-local-am2.md) first.
...
The human-facing subset is two admins, two channels and three units named
`demo_*` / `DEMO_*`. The seed directory also creates isolated `ct_*` protocol
fixtures, making a fresh volume at least four admins, five channels and seven
units in total. Every row remains synthetic so nothing from this database is
mistaken for staging or production data.
