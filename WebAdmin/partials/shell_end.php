...
(() => {
    ...
    document.getElementById('themeToggle')?.addEventListener('click', function () {
        ...
        /*
         * Everything the swap actually is, in one place.
         *
         * The class stays on for the duration: it suppresses the per-element
         * transitions -- without it a few hundred bordered controls each ease
         * to a new colour on their own schedule, which is a sweep across the
         * screen rather than a switch -- and it is what names the root for the
         * view transition. Named permanently it would make the root a stacking
         * context, which is what once put every dialogue under Preline's
         * backdrop, and it would take the root snapshot away from the page
         * transition that uses it on every navigation.
         */
        const apply = () => {
